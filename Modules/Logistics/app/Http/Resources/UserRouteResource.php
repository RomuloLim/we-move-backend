...
class UserRouteResource extends JsonResource
{
    /**
    ...
    public function toArray($request): array
    {
        return [
            ...
            'is_linked' => $this->when(isset($this->is_linked), (bool) $this->is_linked),
            'linked_at' => $this->when(isset($this->linked_at), $this->linked_at),
